...
void star_TransposedMatMul433(sfloat C43[12], const sfloat A34[12], const sfloat B33[9]);
...
void star_MatMulTransposed443(sfloat C43[12], const sfloat A44[16], const sfloat B34[12]);
